...
public class AllCustomerPanel extends JPanel{
    ...
    AllCustomerPanel(){
		...
		tableviewscroll.setBounds(7, 172, 1105, 617);
		...
		table.getTableHeader().setReorderingAllowed(false);
                ...
                try{
                 Conn conn = new Conn();
                 String sql = "select name as 'Customer Name',username as 'Username',password as 'Password',pancard as 'Pancard No.',phone as 'Phone No.',email as 'Email Id' from customers" ;
