...
public class UserPanel extends JPanel implements ActionListener {
    ...
    UserPanel(String adminUsername) {
        this();
...
//                                }
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == b1) {
            new AddUser(this.adminUsername).setVisible(true);
        }
    }
    ...
    public void createtablemodel() {
        try {
            Conn conn = new Conn();
            String sql = "select U.username as 'Username',U.full_name as 'Full Name',U.email as 'E-mail',U.number as 'Number', a.name AS 'Created by' from users U INNER JOIN adminlogins A ON U.created_by = A.id";
