...
public class HotelPanel extends JPanel implements ActionListener{
    ...
    public void createtablemodel()
	{
            try{
                 Conn conn = new Conn();
                 String sql = "select name as 'Hotel Name',state as 'City/State Name',ac as 'AC Cost Per Day',food as 'Food Cost Per Day',hotelcost as 'Hotel Cost Per Day' from hotels" ;
