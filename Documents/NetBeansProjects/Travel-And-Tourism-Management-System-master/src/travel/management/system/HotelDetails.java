...
public class HotelDetails extends JPanel implements ActionListener {
    ...
    HotelDetails() {
        ...
        l6.setBounds(634, 344, 190, 45);
        panel1.add(l6);
        
        l13 = new JLabel("Created by ");
        l13.setFont(new Font("Segoe UI Historic", Font.PLAIN, 20));
        l13.setBorder(new LineBorder(new Color(192, 192, 192)));
        l13.setBackground(Color.WHITE);
        l13.setBounds(634, 388, 190, 45);
        panel1.add(l13);
        ...
        l14.setBounds(824, 388, 360, 45);
        panel1.add(l14);

        l10 = new JLabel();
        l10.setBounds(300, 20, 400, 250);
