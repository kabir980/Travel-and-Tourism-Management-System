...
public class PackageDetails extends JPanel implements ActionListener{
    ...
    PackageDetails(CustomerHome c, String place, String user){
     ...
     PackageDetails(){
		...
		ta1.setBounds(328, 465, 885, 70);
                ta1.setLineWrap(true);
		panel1.add(ta1);
               
                l10 = new JLabel();
		l10.setBounds(300, 15, 500, 360);
