...
public class PackageDetails extends JPanel implements ActionListener {
    ...
    PackageDetails() {
        ...
        l15.setBounds(762, 388, 310, 45);
        panel1.add(l15);

        l10 = new JLabel();
        l10.setBounds(300, 15, 400, 250);
